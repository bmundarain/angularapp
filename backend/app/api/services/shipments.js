                ...
                for (var i = 0; i < shipmentList.materials.length; i++)
                    for(var j = 0; j < packingList.materials.length; j++) {
                        ...
                        if(shipmentList.materials[i].line === packingList.materials[j].line) {
                            ...
                            var differ = packingList.materials[j].quantity - shipmentList.materials[i].quantity
    
                            if(differ > 0)
                                packingList.materials[i].differ = differ
    
                        }
                    }
    
                for(i = 0; i < packingList.materials.length; i++) {
                    if(!packingList.materials[i].checked) {
                        ...
                        packingList.materials[i].differ     = packingList.materials[i].quantity
    
                        packingPunch.push(packingList.materials[i])
                    }
                    else if(packingList.materials[i].differ) {
